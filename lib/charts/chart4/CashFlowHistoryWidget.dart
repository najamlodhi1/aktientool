...
class CashFlowHistoryWidget extends StatefulWidget {
  const CashFlowHistoryWidget(
      {super.key,
      required this.data,
      required this.selectedtitle,
      required this.selectedindex});
  final List<CashFlowReportModel> data;
  final String selectedtitle;
  final int selectedindex;

  @override
  State<CashFlowHistoryWidget> createState() => _CashFlowHistoryWidgetState();
}

class _CashFlowHistoryWidgetState extends State<CashFlowHistoryWidget> {
