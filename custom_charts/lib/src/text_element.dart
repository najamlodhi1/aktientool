...
class TextElement implements common.TextElement {
  ...
  common.CommonTextStyle? _textStyle;
  common.ChartTextDirection _textDirection = common.ChartTextDirection.ltr;
  ...
  TextElement(this.text, {common.CommonTextStyle? style, this.textScaleFactor})
      : _textStyle = style;

  @override
  common.CommonTextStyle? get textStyle => _textStyle;

  @override
  set textStyle(common.CommonTextStyle? value) {
    if (_textStyle == value) {
      return;
    }
    _textStyle = value;
  ...
  @override
  set textDirection(common.ChartTextDirection direction) {
  ...
  @override
  common.ChartTextDirection get textDirection => _textDirection;
