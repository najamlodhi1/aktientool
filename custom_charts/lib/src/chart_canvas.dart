...
class ChartCanvas implements common.ChartCanvas {
  ...
  void drawCircleSector(Point center, double radius, double innerRadius,
      ...
      {common.CustomChartColor? fill,
      common.CustomChartColor? stroke,
  ...
  @override
  void drawLink(common.Link link, common.LinkOrientation orientation,
      common.CustomChartColor fill) {
  ...
  ui.Gradient _createHintGradient(
      double left, double top, common.CustomChartColor fill) {
  ...
  void drawRRect(Rectangle<num> bounds,
      {common.CustomChartColor? fill,
      common.CustomChartColor? stroke,
      common.CustomChartColor? patternColor,
  ...
  void drawText(common.TextElement textElement, int offsetX, int offsetY,
    ...
    if (rotation != 0) {
      ...
      if (textDirection == common.ChartTextDirection.rtl) {
      ...
      if (textDirection == common.ChartTextDirection.center) {
  ...
  _drawForwardHatchPattern(
    ...
    Canvas canvas, {
    common.CustomChartColor? background,
    common.CustomChartColor? fill,
