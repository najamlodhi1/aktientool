...
class SankeyGraph<N, L, D> extends Graph<N, L, D> {
  ...
  SankeyGraph._({
    ...
    TypedAccessorFn<Node<N, L>, CustomChartColor>? nodeColorFn,
    TypedAccessorFn<Node<N, L>, CustomChartColor>? nodeFillColorFn,
    TypedAccessorFn<Node<N, L>, FillPatternType>? nodeFillPatternFn,
    TypedAccessorFn<Node<N, L>, num>? nodeStrokeWidthPxFn,
    TypedAccessorFn<Link<N, L>, CustomChartColor>? linkFillColorFn,
  }) : super.base(
            id: id,
            nodes: nodes,
            links: links,
