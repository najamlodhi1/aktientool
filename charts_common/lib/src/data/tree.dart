...
class Tree<T, D> {
  ...
  final TypedAccessorFn<TreeNode<T>, CustomChartColor>? colorFn;
  ...
  final TypedAccessorFn<TreeNode<T>, CustomChartColor>? fillColorFn;

  /// Accessor function that returns the pattern color for a tree node
  /// If not provided, then background color is used as default.
  final TypedAccessorFn<TreeNode<T>, CustomChartColor>? patternColorFn;
  ...
  factory Tree({
    ...
    TypedAccessorFn<T, CustomChartColor>? colorFn,
    TypedAccessorFn<T, CustomChartColor>? fillColorFn,
    TypedAccessorFn<T, CustomChartColor>? patternColorFn,
    ...
    return Tree._(
      ...
      colorFn: _castFrom<T, CustomChartColor>(colorFn),
      fillColorFn: _castFrom<T, CustomChartColor>(fillColorFn),
      fillPatternFn: _castFrom<T, FillPatternType>(fillPatternFn),
      patternColorFn: _castFrom<T, CustomChartColor>(patternColorFn),
