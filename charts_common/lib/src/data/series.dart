...
class Series<T, D> {
  ...
  final CustomChartColor? seriesColor;
  ...
  final AccessorFn<CustomChartColor>? areaColorFn;
  ...
  /// If neither are provided, then the chart will insert colors for each series
  /// on the chart using a mapping function.
  final AccessorFn<CustomChartColor>? colorFn;
  ...
  factory Series(
      ...
      String? displayName,
      CustomChartColor? seriesColor,
      TypedAccessorFn<T, CustomChartColor>? areaColorFn,
