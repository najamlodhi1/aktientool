...
class Graph<N, L, D> {
  ...
  final TypedAccessorFn<Node<N, L>, CustomChartColor>? nodeColorFn;

  /// Accessor function that returns the fill color of a node
  final TypedAccessorFn<Node<N, L>, CustomChartColor>? nodeFillColorFn;
  ...
  /// Accessor function that returns the fill color of a node
  final TypedAccessorFn<Link<N, L>, CustomChartColor>? linkFillColorFn;
  ...
  factory Graph(
      ...
      TypedAccessorFn<N, CustomChartColor>? nodeColorFn,
      TypedAccessorFn<N, CustomChartColor>? nodeFillColorFn,
      TypedAccessorFn<N, FillPatternType>? nodeFillPatternFn,
      TypedAccessorFn<N, num>? nodeStrokeWidthPxFn,
      TypedAccessorFn<L, CustomChartColor>? linkFillColorFn}) {
    return Graph.base(
      id: id,
      ...
      nodeColorFn: actOnNodeData<N, L, CustomChartColor>(nodeColorFn),
      nodeFillColorFn: actOnNodeData<N, L, CustomChartColor>(nodeFillColorFn),
      nodeFillPatternFn:
          actOnNodeData<N, L, FillPatternType>(nodeFillPatternFn),
      nodeStrokeWidthPxFn: actOnNodeData<N, L, num>(nodeStrokeWidthPxFn),
      linkFillColorFn: actOnLinkData<N, L, CustomChartColor>(linkFillColorFn),
    );
  }
