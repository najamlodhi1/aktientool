...
import '../../../../common/text_element.dart'
    show ChartTextDirection, TextElement, MaxWidthStrategy;
...
abstract class BaseTickDrawStrategy<D> implements TickDrawStrategy<D> {
      ...
      if (orientation == AxisOrientation.bottom ||
        ...
        if (orientation == AxisOrientation.left) {
          if (tickLabelJustification == TickLabelJustification.inside) {
            ...
            line.textDirection = ChartTextDirection.rtl;
          } else {
            x = axisBounds.left;
            line.textDirection = ChartTextDirection.ltr;
          }
        } else {
          // orientation == right
          if (tickLabelJustification == TickLabelJustification.inside) {
  ...
  ChartTextDirection _normalizeHorizontalAnchor(
      TickLabelAnchor anchor, bool isRtl, bool isFirst, bool isLast) {
    switch (anchor) {
      case TickLabelAnchor.before:
        return isRtl ? ChartTextDirection.ltr : ChartTextDirection.rtl;
      case TickLabelAnchor.after:
        return isRtl ? ChartTextDirection.rtl : ChartTextDirection.ltr;
      case TickLabelAnchor.inside:
        if (isFirst) {
          return ChartTextDirection.ltr;
        }
        if (isLast) {
          return ChartTextDirection.rtl;
        }
        return ChartTextDirection.center;
