...
abstract class ChartCanvas {
  ...
  void drawCircleSector(Point center, double radius, double innerRadius,
      ...
      {CustomChartColor? fill,
      CustomChartColor? stroke,
  ...
  void drawLink(Link link, LinkOrientation orientation, CustomChartColor fill);
...
CustomChartColor getAnimatedColor(CustomChartColor previous,
    CustomChartColor target, double animationPercent) {
  ...
  return CustomChartColor(a: a, r: r, g: g, b: b);
}
