...
class MutableSeries<D> extends ImmutableSeries<D> {
  ...
  @override
  AccessorFn<CustomChartColor?>? areaColorFn;

  @override
  AccessorFn<CustomChartColor>? colorFn;

  @override
  AccessorFn<List<int>?>? dashPatternFn;

  @override
  AccessorFn<CustomChartColor?>? fillColorFn;

  @override
  AccessorFn<FillPatternType?>? fillPatternFn;

  @override
  AccessorFn<CustomChartColor?>? patternColorFn;
...
abstract class ImmutableSeries<D> {
  ...
  CustomChartColor? get seriesColor;
  ...
  AccessorFn<CustomChartColor?>? get areaColorFn;

  AccessorFn<CustomChartColor?>? get colorFn;

  AccessorFn<List<int>?>? get dashPatternFn;

  AccessorFn<CustomChartColor?>? get fillColorFn;

  AccessorFn<CustomChartColor?>? get patternColorFn;
