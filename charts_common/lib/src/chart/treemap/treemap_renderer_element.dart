...
class TreeMapRendererElement<D> {
  ...
  TreeMapRendererElement<D> clone() => TreeMapRendererElement(
        ...
        fillColor: fillColor == null
            ? null
            : CustomChartColor.fromOther(color: fillColor!),
        patternColor: patternColor == null
            ? null
            : CustomChartColor.fromOther(color: patternColor!),
        strokeColor: strokeColor == null
            ? null
            : CustomChartColor.fromOther(color: strokeColor!),
