...
import '../../common/color.dart' show CustomChartColor;
import '../../common/graphics_factory.dart' show GraphicsFactory;
import '../../common/style/style_factory.dart' show StyleFactory;
import '../../common/text_element.dart'
    show MaxWidthStrategy, ChartTextDirection, TextElement;
import '../../common/text_style.dart' show CommonTextStyle;
...
class ArcLabelDecorator<D> extends ArcRendererDecorator<D> {
  ...
  static final _defaultInsideLabelStyle =
      TextStyleSpec(fontSize: 12, color: CustomChartColor.white);
  static final _defaultOutsideLabelStyle = TextStyleSpec(
      fontSize: 12, color: CustomChartColor.fromHex(code: '#B6C2D0'));
  ...
  ArcLabelDecorator(
      ...
      CustomChartColor? leaderLineColor})
  ...
  CommonTextStyle _getDatumStyle(AccessorFn<TextStyleSpec>? labelFn,
      int? datumIndex, GraphicsFactory graphicsFactory,
      {required CommonTextStyle defaultStyle}) {
  ...
  void _drawInsideLabel(
    ...
    labelElement.textDirection = ChartTextDirection.center;
  ...
  List<Object>? _drawOutsideLabel(
    ...
    labelElement.textDirection =
        labelLeftOfChart ? ChartTextDirection.rtl : ChartTextDirection.ltr;
