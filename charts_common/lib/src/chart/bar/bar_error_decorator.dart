...
class BarErrorDecorator<D> extends BarRendererDecorator<D> {
  static const CustomChartColor _defaultStrokeColor = CustomChartColor.black;
  static const double _defaultStrokeWidthPx = 1;
  static const double _defaultEndpointLengthPx = 16;

  static const CustomChartColor _defaultOutlineColor = CustomChartColor.white;
  ...
  final CustomChartColor strokeColor;
  final CustomChartColor outlineColor;
