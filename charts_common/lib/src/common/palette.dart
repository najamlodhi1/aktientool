...
abstract class Palette {
  ...
  /// The default shade.
  CustomChartColor get shadeDefault;

  /// Returns a list of colors for this color palette.
  List<CustomChartColor> makeShades(int colorCnt) {
    final colors = <CustomChartColor>[shadeDefault];
    ...
    colors.add(
        CustomChartColor.fromOther(color: shadeDefault, lighter: lighterColor));
    return colors;
  }

  CustomChartColor _getSteppedColor(
      CustomChartColor color, int index, int steps,
      {CustomChartColor? darker, CustomChartColor? lighter}) {
