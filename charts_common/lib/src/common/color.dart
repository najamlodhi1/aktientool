...
class CustomChartColor {
  ...
  final CustomChartColor? _darker;
  final CustomChartColor? _lighter;

  const CustomChartColor({
    required this.r,
    required this.g,
    required this.b,
    this.a = 255,
    CustomChartColor? darker,
    CustomChartColor? lighter,
  })  : _darker = darker,
        _lighter = lighter;

  CustomChartColor.fromOther(
      {required CustomChartColor color,
      CustomChartColor? darker,
      CustomChartColor? lighter})
      : r = color.r,
        g = color.g,
  ...
  factory CustomChartColor.fromHex({required String code}) {
    ...
    final b = bigint & 255;
    final a = 255;
    return CustomChartColor(r: r, g: g, b: b, a: a);
  }

  CustomChartColor get darker =>
      _darker ??
      CustomChartColor(
