...
import 'text_style.dart' show CommonTextStyle;

/// Interface for accessing text measurement and painter.
abstract class TextElement {
  /// The [TextStyle] of this [TextElement].
  CommonTextStyle? get textStyle;

  set textStyle(CommonTextStyle? value);
  ...
  /// The opacity of this element, in addition to the alpha set on the CustomChartColor
  /// of this element.
  ...
  ChartTextDirection get textDirection;
  set textDirection(ChartTextDirection direction);
